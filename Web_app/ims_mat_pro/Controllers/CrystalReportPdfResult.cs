...
namespace ims_cloud.Controllers
{
    public class CrystalReportPdfResult : ActionResult
    {
        private readonly byte[] _contentBytes;

        public CrystalReportPdfResult(ReportDocument rptDoc)
        {
            //ReportDocument reportDocument = new ReportDocument();
            //reportDocument.Load(reportPath);
            //reportDocument.SetDataSource(dataSet);
            _contentBytes = StreamToBytes(rptDoc.ExportToStream(ExportFormatType.PortableDocFormat));
        }
