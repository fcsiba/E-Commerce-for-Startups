...
public class AdapterNotificationView extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<Thread_Messages> items;
    private Context ctx;
    private OnItemClickListener mOnItemClickListener;
    NotificationView ntView;
    ...
    public AdapterNotificationView(Context context, List<Thread_Messages> _msgs, NotificationView _ntView, RecyclerView _rv) {
        ctx = context;
        items = _msgs;
        ntView = _ntView;
        recyclerView = _rv;
        ...
        if (holder instanceof ItemViewHolder) {
            ...
            vItem.lyt_parent.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    Toast.makeText(ctx, m.getTitle(), Toast.LENGTH_SHORT).show();
                    return true;
                }
            });
        }
