...
public class IntroActivityMarks extends AppCompatActivity {
    ...
    private String about_description_array[] = {
            ...
            "Enter marks that the students have obtained.",
    };
    private int about_images_array[] = {
            R.drawable.attendance_help_5,
            R.drawable.attendance_help_6,
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intro_marks);
