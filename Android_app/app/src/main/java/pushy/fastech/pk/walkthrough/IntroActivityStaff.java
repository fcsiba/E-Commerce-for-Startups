...
public class IntroActivityStaff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restorePrefData()) {
            Intent mainActivity = new Intent(getApplicationContext(), StaffDashboard.class);
            startActivity(mainActivity);
            finish();
        }

        setContentView(R.layout.activity_intro_staff);
