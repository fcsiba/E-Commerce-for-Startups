...
public class FragmentStudentsLeft extends Fragment {

    public FragmentStudentsLeft() {
    }

    public static FragmentStudentsLeft newInstance() {
        FragmentStudentsLeft fragment = new FragmentStudentsLeft();
        return fragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_student_left, container, false);

        TextView title  = (TextView) root.findViewById(R.id.txtTitle);
        title.setText("Students Leftt");
