...
public class FragmentStudentsEnrolled extends Fragment {

    public FragmentStudentsEnrolled() {
    }

    public static FragmentStudentsEnrolled newInstance() {
        FragmentStudentsEnrolled fragment = new FragmentStudentsEnrolled();
        return fragment;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_student_enrolled, container, false);

        TextView title  = (TextView) root.findViewById(R.id.txtTitle);
        title.setText("Students Present");
