...
//    public static List<Homework> getHomeworkData(Context ctx){
//        List<Homework> items = new ArrayList<>();
//        String class_arr[] = ctx.getResources().getStringArray(R.array.people_names);
//
//        for (int i = 0; i < class_arr.length; i++) {
//            Homework obj = new Homework();
//            obj.myClass = class_arr[i];
//            obj.section = class_arr[i];
//            obj.subject = class_arr[i];
//            obj.date = class_arr[i];
//            obj.dueDate = class_arr[i];
//            obj.dueTime = class_arr[i];
//            obj.homework = class_arr[i];
//        }
//        Collections.shuffle(items);
//        return items;
//    }
    ...
    public static List<Products> GetProducts(Context ctx, Integer mainID, Integer subCat) {
