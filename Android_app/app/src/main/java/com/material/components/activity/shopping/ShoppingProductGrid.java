...
public class ShoppingProductGrid extends AppCompatActivity {
    ...
    Integer mainCategory = 1; //Men by default
    ...
    private void initComponent() {
        ...
        if (mainCategory == 1)
        {
            Snackbar.make(parent_view, "Men", Snackbar.LENGTH_SHORT).show();
        }
        else if (mainCategory == 2)
        {
            Snackbar.make(parent_view, "Women", Snackbar.LENGTH_SHORT).show();
        }
        else if (mainCategory == 3)
        {
            Snackbar.make(parent_view, "Kids", Snackbar.LENGTH_SHORT).show();
        }

        List<Products> items = null;
        ...
        mAdapter.setOnItemClickListener(new AdapterGridShopProductCard.OnItemClickListener() {
            ...
            public void onItemClick(View view, Products obj, int position) {
                Snackbar.make(parent_view, "Item " + obj.getItemName() + " clicked", Snackbar.LENGTH_SHORT).show();
            }
        });
