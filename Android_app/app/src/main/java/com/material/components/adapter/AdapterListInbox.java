...
public class AdapterListInbox extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListInbox(Context mContext, List<Inbox> items, int animation_type) {
        this.ctx = mContext;
        this.items = items;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            ((ViewHolder) holder).from.setText(inbox.from);
            ((ViewHolder) holder).email.setText(inbox.email);
//            ((ViewHolder) holder).message.setText(inbox.message);
//            ((ViewHolder) holder).date.setText(inbox.date);
            ((ViewHolder) holder).image_letter.setText(inbox.from.substring(0, 1));
